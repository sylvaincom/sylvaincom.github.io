...
<table>
  ...
  <tr>
    <td colspan="3">
      <ul>
        <li>:probabl. is the official brand operator of <a href="https://scikit-learn.org/stable/">scikit-learn</a>, the reference open-source machine learning Python library. :probabl. is an <i>Entreprise à Mission de Souveraineté Industrielle et Numérique</i> and a spin-off of Inria. More info: [Notion page](https://probabl.notion.site/Get-to-know-Probabl-127ef76d36b9804d8ca8e264e42f0cee?pvs=4).
        </li>
